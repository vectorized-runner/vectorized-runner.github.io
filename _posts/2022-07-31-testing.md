...
As you can see there are some cases to be avoided, but for experienced programmers it shouldn't be much of a deal.

I'm not going to provide the full implementation here, as rest of the implementation is ordinary. You can get the full source code from here: //TODO
